...
const sections = {
  sections: {
    ...
    options: [
      ...
      { name: 'Commentaires', to: '/admin/sections/delete' },
      { name: 'Notes', to: '/admin/sections/delete' },
      { name: 'Favoris', to: '/admin/sections/delete' },
      { name: 'Wishlist', to: '/admin/sections/delete' },
      { name: 'Lectures', to: '/admin/sections/delete' },
    ],
  },
  lists: {
